...
import { CheckCircle, Calendar, RefreshCw, AlertTriangle } from 'lucide-react';
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="bg-white border rounded-xl p-6 space-y-4">
                    ...
                    <button
                        ...
                        className="w-full bg-blue-600 text-white rounded-lg py-2 flex items-center justify-center gap-2"
                    >
                ...
                <div className="bg-white border rounded-xl p-6 space-y-4">
                    ...
                    <button
                        ...
                        className="w-full bg-slate-900 text-white rounded-lg py-2 flex items-center justify-center gap-2"
                    >
            ...
            <div className="bg-white border rounded-xl p-6 space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-3">
                    ...
                    <input
                        ...
                        onChange={(e) => setAddressForm(prev => ({ ...prev, mobile_no: e.target.value }))}
                ...
                <div className="space-y-2">
                    {(lead.addresses || []).map((row) => (
                        <div key={row.address_id} className="border rounded-lg p-3 text-sm flex items-start justify-between gap-3">
                            <div>
                                <div className="font-semibold">{row.concern_person || 'Contact'}</div>
